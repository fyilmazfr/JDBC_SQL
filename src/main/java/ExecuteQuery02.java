...
public class ExecuteQuery02 {
    public static void main(String[] args) throws SQLException {
        ...
        //once siraladik ,offset ile satir atlattik ve ilk siradakini al dedik limit ile, yani 2. yi almis oldu
        ResultSet resultSet1 = statement.executeQuery(sql1);

        while (resultSet1.next()) {

            System.out.println(resultSet1.getString("company") + " -- " + resultSet1.getInt("number_of_employees"));
            //int degerini getInt ile aliyoruz eger getString yapsak hata aliriz
