...
//sout un icinde her bir sutunu yazdiriyoruz
        }
        ...
        while (resultSet2.next()) {// cagirdigimiz datayi okumaya baliyacak,her defasinda bir alt satira inecek, ta ki satir bitene kadar


            System.out.println(resultSet2.getString("country_id") + " -- " + resultSet2.getString("country_name"));
            //getString bize gelen bilgiyi stringe cevirmrmize yani okumamaiza yarar
